...
Figure <a name="yearly cost"></a> 1: The total yearly cost of ownership for a new 2023

</figure> 
![Caption.](
<img src="YearlyCostOfOwnership.png" width= "700">){#fig:id}
The first five yearly cost to own a new 2023 vehicle is plotted in Figure <a name="yearly cost"></a> 1:
